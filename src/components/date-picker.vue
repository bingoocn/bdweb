...
<template>
    <div class="datetime-picker" :style="{ width: width }">
        <input type="text" :style="styleObj" :ref="type" :readonly="readonly" :value="pickVal" @click="show = !show;pickDate">
    ...
    export default {
        ...
        methods: {
            ...
            pickDate (index) {
                ...
                this.pickVal = this.stringify();

                for(var key in this.$refs){
                  key = key;
                }
                this.$emit('get', {name: key, value:this.now})
            },
            parse (str) {
