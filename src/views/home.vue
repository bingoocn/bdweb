  ...
  <div>
    ...
    <div class="row margin-top-10">
      <div class="col-xs-12 col-md-7">
        <news-box></news-box>
        <chart-box title="星历星座" path="/home"></chart-box>
        <videos-box></videos-box>
      </div>
      <div class="col-xs-12 col-md-5">
        <div class="row">
          <div class="col-xs-12">
            ...
            :param="{title:'官方下载',hastop:true,hasbottom:false,slice:2}">
            </notice-box>
          </div>
        </div>
        ...
        <div class="row margin-top-10">
          <div class="col-xs-12">
            ...
            :param="{title:'常见问题',hastop:false,hasbottom:true,slice:6}">
            </notice-box>
          </div>
        </div>
      </div>
...
<script>
  ...
  import VideosBox from '../components/videos'
  import CharacterBox from '../components/character'
  ...
  export default{
    ...
    components: {
      BroadcastBox,NewsBox,ChartBox,VideosBox,CharacterBox,NoticeBox
    }
  }
</script>
